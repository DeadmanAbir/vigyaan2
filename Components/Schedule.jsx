...
import Hackathon from "../images/events/hackathon.jpg";
import Vivaad from "../images/events/vaad_vivaad.png";
import Sciencetopia from "../images/events/sciencetopia.avif";
import Exhibition from "../images/events/science_exhibition.png";
import Photography from "../images/events/photography.png";
import Paper from "../images/events/paper_comp.png";
import PosterCompetition from "../images/events/Poster_competition.jpeg";
import Showdown from "../images/events/quiz_showdown.png";
import StandUp from "../images/events/stand-up.jpeg";

import SciencePaperCompetition from "../images/events/paper_comp.pdf";
import Quiz from "../images/events/quiz_showdown.pdf";
import photography from "../images/events/photography.pdf";
import ScienceExhibition from "../images/events/science_exhibition.pdf";
import VaadVivaad from "../images/events/vaad_vivaad.pdf";
function Schedule() {
  return (
    <>
      <section id="Schedule">
        <div className="bg-[#001736]">
          ...
          <div className="py-10 bg-[#001736] flex justify-center">
            <a
              href={scheduleImage}
              download
              className="bg-[#000] hover:bg-[#155e89] hover:text-white hover:border-[#1B1A55] text-[#9290C3] font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline border border-[#535C91] "
            >
              Download Schedule
            </a>
          </div>
        ...
        <div
          id="events"
          className="wow fadeInUp relative overflow-hidden pt-17.5 lg:pt-22.5 xl:pt-27.5 bg-[#001736] text-[#fff]"
        >
          <div className="max-w-[1170px] mx-auto px-4 sm:px-8 xl:px-0">
            <div className="max-w-full mx-auto px-4 my-5 sm:px-8 xl:px-0">
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 sm:gap-7.5 ">
                <div
                  className="wow fadeInUp group bg-[#03396c] backdrop-filter backdrop-blur-sm rounded-lg overflow-hidden h-[36em]"
                ...
                >
                  <div className="overflow-hidden">
                    <img
                      ...
                      src={Hackathon}
                      alt="Event"
                      className="ease-linear w-full duration-500 scale-100 group-hover:scale-125 h-80"
                    />
                  </div>

                  <div className="p-4 h-60 flex flex-col justify-between">
                    <h4 className="red-hat text-4xl font-black transition-opacity duration-300 ease-in-out hover:opacity-60">
                      Hackathon
                    </h4>
                    <p className="font-extralight opacity-80">
                      Unleash your inner Coder! Collaborate in teams and code,
                      design, and build ingenious solutions to real-world
                      problems. Witness the power of teamwork and unfold the
                      innovation
                    </p>
                    <div className="w-full flex justify-center">
                      <a
                        href="https://vigyaan.devfolio.co/"
                        target="_blank"
                        className="bg-white text-[#000] flex justify-center items-center p-2 w-9/12 rounded-md"
                      >
            ...
            55.41 0 0 1 50.58 55.34z"
                        ...
                        <p className="text-center text-1xl sm:2xl">
                          {" "}
                          Apply with Devfolio
                        </p>
                      </a>
                ...
                <EventCard
                  showDownloadButton={true}
                  PDFLink={SciencePaperCompetition}
                  imageSrc={Paper}
